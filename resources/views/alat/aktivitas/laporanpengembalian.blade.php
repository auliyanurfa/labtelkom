      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div class="p-5 mb-4 bg-light rounded-3 col-12">
          <div class="container-fluid py-5">
            <h1 class="display-7 fw-bold">Laporan Pengembalian</h1>
            <p class="col-md-10 fs-5">Halaman yang berisi laporan pengembalian.</p>
          </div>
        </div>
      </div>
{{--
      ...
      <div class="container">
        <div class="col-12 table-responsive mt-1">
            <table class="table table-bordered table-striped" id="pengembalian" style="width:100%">
              <thead>
                <tr>
                  <th scope="col">No</th>
