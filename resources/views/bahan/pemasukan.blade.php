        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div class="p-5 mb-4 bg-light rounded-3">
                <div class="container-fluid py-5">
                    ...
                    <p class="col-md-10 fs-5">Halaman yang berisi mengenai aktivitas admin untuk melakukan pemasukan atau
                        input barang material praktikum di Laboratorium Barat.
                    <h6>{{ $date }}</h6>
                    </p>
                </div>
            </div>
                            ...
                            <form id="pemasukanForm" name="pemasukanForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="barcode" placeholder="Barcode"
                                        name="barcode" autofocus required>
                                    {{-- nama bhp --}}
                                    <label for="disabledTextInput" class="form-label"></label>
                                    <input type="text" class="form-control @error('name_material') is-invalid @enderror"
                                        id="name_material" name="name_material"placeholder="Nama Material" required
                                        readonly='true'>
                                    {{-- stok awal --}}
                                    <label for="disabledTextInput2" class="form-label"></label>
                                    <input type="text" class="form-control @error('stok') is-invalid @enderror"
                                        id="stok" name="stok" placeholder="Sisa Stok" required readonly='true'>
                                    {{-- stok masuk --}}
                                    <label for="Stok" class="form-label"></label>
                                    <input type="text" class="form-control @error('stok_masuk') is-invalid @enderror"
                                        id="stok_masuk" name="stok_masuk"placeholder="Stok Masuk" required>
                                    {{-- satuan --}}
                                    <label for="Stok" class="form-label"></label>
                                    <input type="text" class="form-control @error('satuan') is-invalid @enderror"
                                        id="satuan" name="satuan"placeholder="satuan" required readonly='true'>
