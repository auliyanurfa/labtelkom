        ...
        <div class="row d-flex justify-content-center mt-5">
            ...
            <div class="card border-primary">
                ...
                <div class="card-body text-primary">
                    ...
                    <p class="card-text">Bagian ini memuat perihal peralatan laboratorium yang dipergunakan dalam pelaksanaan praktikum.</p>
            ...
            <div class="card border-primary">
                ...
                <div class="card-body text-primary">
                    ...
                    <p class="card-text">Bagian ini memuat perihal bahan habis pakai laboratorium yang dipergunakan dalam pelaksanaan praktikum.</p>
